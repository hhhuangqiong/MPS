...
export function createSipGatewayCreationTask(logger, cpsOptions, voiceProvisioningManagement) {
  ...
  return createTask('SIP_GATEWAY_CREATION', run, { validateRerun }, logger);
}
